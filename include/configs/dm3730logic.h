 ...
 * the product ID data */
#define CONFIG_DM3730LOGIC_USE_PRODUCT_ID	1
#endif
...
#define FOUR_BIT_ERROR_SOFT_CORRECT

/* Define constants for 512 bytes, 7 byte 4-bit BCH ECC; values of M, T
 * derived from running code.  Constants should speed up BCH encoding
 * by factor of 2 */
...
#define COMMANDLINE	"console=ttyO0,115200n8 display=walnut root=/dev/mmcblk0p2 rw rootfstype=ext3 rootwait dispargs=omapfb.vrfb=y omapfb.rotate=0 mtdparts=omap2-nand:512k(xload),-(data) ignore_loglevel early_printk no_console_suspend mpurate=720"


#define CFG_RAM_START 	OMAP34XX_SDRC_CS0
#define CFG_RAM_SIZE 	0x10000000
#define CFG_LOADFILE    "zImage"
#endif /* __CONFIG_H */
