...
static struct sdram_timings sdram_timings[] = {
	{
	.name		= "MT46H128M32L2K1-5 512M",
	.offset		= 0x10000000,
	.mcfg		= { 0x03588099, 0x03588099 },
	.rfr		= { 0x000a2801, 0x000a2801 },
	.actima		= { 0x629DB4C6, 0x629DB4C6 },
	.actimb		= { 0x00011113, 0x00011113 },
...
{
	int i;
	struct sdram_timings sdram_timing;

#ifdef CONFIG_DM3730LOGIC_USE_PRODUCT_ID
	if (dm3730logic_has_product_id()) {
		if (!dm3730logic_extract_ddr_timing(&sdram_timing)) {
			sdrc_ddr(&sdram_timing);
			return;
		}
	}
#endif
